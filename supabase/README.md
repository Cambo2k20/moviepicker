...
`20260824103055_harden_journal_entry_numbering.sql` and `20260824104512_protect_sessions_on_member_removal.sql` were developed and verified against a local Supabase stack only. **Neither has been applied to the hosted project.**
